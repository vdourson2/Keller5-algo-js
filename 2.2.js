let petit = prompt("Entrer un nombre","Nombre");
let grand = prompt("Entrer un nombre supérieur au nombre précédent","Nombre supérieur");
if (grand<=petit){
    ...
    let courant = prompt("Entrer un troisième nombre au hasard","Nombre au hasard");
